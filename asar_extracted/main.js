...
// ── PVP Clients ───────────────────────────────────────────────────
const PVP_CLIENTS = [
    { id: 'lunar', name: 'Lunar Client', icon: '🌙', color: '#38bdf8', desc: 'El cliente PVP más popular para todas las versiones de Minecraft. Máximo boost de FPS, cosméticos y mods competitivos.', desc_en: 'The most popular PVP client for all Minecraft versions. Maximum FPS boost, cosmetics, and competitive mods.', desc_pt: 'O cliente PVP mais popular para todas as versões do Minecraft. Aumento máximo de FPS, cosméticos e mods competitivos.', url: 'https://www.lunarclient.com/' },
    { id: 'badlion', name: 'Badlion Client', icon: '🦁', color: '#fbbf24', desc: 'Cliente PVP avanzado con anticheat BLC, mods competitivos, HUD integrado y optimización gráfica extrema.', desc_en: 'Advanced PVP client with BLC anticheat, competitive mods, integrated HUD, and extreme graphics optimization.', desc_pt: 'Cliente PVP avançado com anticheat BLC, mods competitivos, HUD integrado e otimização gráfica extrema.', url: 'https://www.badlion.net/' },
    { id: 'feather', name: 'Feather Client', icon: '🪶', color: '#60a5fa', desc: 'Cliente ultraligero con soporte integrado para mods Forge/Fabric, chat de voz posicional y hosting de servidores.', desc_en: 'Ultralight client with built-in Forge/Fabric mod support, positional voice chat, and server hosting.', desc_pt: 'Cliente ultraleve com suporte integrado para mods Forge/Fabric, chat de voz posicional e hospedagem de servidores.', url: 'https://feathermc.com/' },
